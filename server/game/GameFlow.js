...
const FLOW_DEFINITION = {
  ...
  [PHASES.DAY_MAYOR_NOMINATE]: { next: PHASES.DAY_MAYOR_VOTE },
  [PHASES.DAY_MAYOR_SPEECH]: { next: PHASES.DAY_MAYOR_WITHDRAW },
  [PHASES.DAY_MAYOR_WITHDRAW]: { next: PHASES.DAY_MAYOR_VOTE },
  [PHASES.DAY_MAYOR_VOTE]: { next: PHASES.DAY_DISCUSSION },
  [PHASES.DAY_MAYOR_PK_SPEECH]: { next: PHASES.DAY_MAYOR_PK_VOTE },
  [PHASES.DAY_MAYOR_PK_VOTE]: { next: PHASES.DAY_DISCUSSION },
